...
<head>
    ...
    <title>Clientes</title> <!-- Establece el título de la página como "inicio" -->
</head>
...
<body>
        ...
        <header class="header"> <!-- Cabecera de la página -->
            ...
            <div class="welcome-message">
                <p class="welcome-text">
                    ...
                    <span class="welcome-text-white">Bienvenido,</span>
    ...
    <main> <!-- Contenido principal de la página -->
        <div class="columna"> <!-- Contenedor de la columna de productos -->
            ...
            <div class="producto">
                <a href="{{ url('/nikecliente') }}"> <!-- Enlace a la página de poleras -->
